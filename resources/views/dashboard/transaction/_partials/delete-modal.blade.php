<div id="transaction-delete-modal-{{ $transaction->id }}" tabindex="-1"
          ...
          <div class="p-4 text-center">
              ...
              <form method="POST" action="{{ route('transactions.destroy', $transaction->id) }}">
                ...
                @method('DELETE')
                  ...
                  <button type="button" data-modal-hide="transaction-delete-modal-{{ $transaction->id }}" class="px-5 py-2.5 ms-3 border rounded-lg">Batalkan</button>
              </form>
          </div>
      </div>
  </div>
