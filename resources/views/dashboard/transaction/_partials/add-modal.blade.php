<div id="add-transaction-modal" class="pt-12 hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full h-screen bg-black bg-opacity-50 backdrop-blur-sm">
  <div class="relative p-4 w-full max-w-md max-h-full">
      <div class="bg-white rounded-lg shadow-sm overflow-y-auto max-h-[80vh]">
          ...
          <div class="flex items-center justify-between p-4 border-b">
              ...
              <button type="button" class="text-gray-400 hover:text-gray-900" data-modal-toggle="add-transaction-modal">&times;</button>
          </div>
