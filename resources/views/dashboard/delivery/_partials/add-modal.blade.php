  ...
  <div class="relative p-4 w-full max-w-md max-h-full">
      <div class="bg-white rounded-lg shadow-sm overflow-y-auto max-h-[80vh]">
          ...
          <div class="flex items-center justify-between p-4 border-b">
              <h3 class="text-lg font-semibold text-gray-900">Tambah Pengiriman</h3>
              <button type="button" class="text-gray-400 hover:text-gray-900" data-modal-toggle="add-delivery-modal">&times;</button>
          </div>

          <form action="{{ route('delivery.store') }}" method="POST" class="p-4">
              @csrf

              <div class="grid gap-4 mb-4">
                <div class="col-span-2">
                    <label for="to_outlet_id">Ke Outlet</label>
                    <select name="to_outlet_id" id="to_outlet_id" required class="w-full rounded-lg p-2.5 bg-gray-50">
              ...
              <div class="grid gap-4 mb-4">
                <div class="col-span-2">
                  <label for="send_date" class="block mb-2 text-sm font-medium text-gray-900">
                    Tanggal Kirim
                  </label>
                  <div class="relative">
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const toSelect = document.getElementById("to_outlet_id");
