  ...
  <div class="relative p-4 w-full max-w-md max-h-full">
      <div class="bg-white rounded-lg shadow-sm">
          <div class="p-4 text-center">
              ...
              <h3 class="mb-5 text-lg font-normal text-gray-500">Apakah anda yakin ingin menghapus Barang ini dari Pengiriman?</h3>
              <form method="POST" action="{{ route('delivery.detail.destroy', $delivery->id) }}">
                @csrf
                @method('DELETE')
