<div id="division-delete-modal-{{ $division->id }}" tabindex="-1"
  ...
  <div class="relative p-4 w-full max-w-md max-h-full">
      <div class="bg-white rounded-lg shadow-sm">
          <div class="p-4 text-center">
              ...
              <h3 class="mb-5 text-lg font-normal text-gray-500">Apakah anda yakin ingin menghapus division ini?</h3>
              <form method="POST" action="{{ route('division.destroy', $division->id) }}">
                ...
                @method('DELETE')
                  ...
                  <button type="button" data-modal-hide="division-delete-modal-{{ $division->id }}" class="px-5 py-2.5 ms-3 border rounded-lg">Batalkan</button>
              </form>
          </div>
      </div>
  </div>
